...
- [YIELD INTELLIGENCE](https://github.com/thebrierfox/intuitek-ace) - AI passive income analyzer via MCP. Live U.S. Treasury rates, dividend ETFs, REIT yields, and portfolio income optimization. No API key required.
