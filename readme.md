...
- Ethereum
  ...
  - [ohmydai!](https://ohmydai.io/)([source code](https://github.com/ohmydai)) - Protocol for issuing options between ERC20 token pairs based on the Convexity protocol whitepaper.
